...
public class To3_8 extends Fragment {

    View view;
    public static TextView Title;

    public static To3_8 newInstance(){
        To3_8 to1 = new To3_8();
        return to1;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_toner3_to8, container, false);

        Title = (TextView) view.findViewById(R.id.To8_Title);
